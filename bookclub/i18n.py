...
T: dict[str, dict[str, TranslationValue]] = {
    "en": {
        ...
        "admin_notify_one_btn": "🔔 Send reminder (pick books)",
        "admin_notify_chat_btn": "💬 Post voting reminder to chat (top)",
        "admin_notify_chat_one_btn": "💬 Post reminder to chat (pick books)",
        ...
        "choose_notify_books": "🔔 Tap books to include in the reminder. Selected: <b>{count}</b>",
        "choose_notify_chat_books": "💬 Tap books to post in the group chat. Selected: <b>{count}</b>",
        "notify_books_send_btn": "✅ Send reminders",
        "notify_books_post_chat_btn": "✅ Post to chat",
        "notify_no_books_selected": "⚠️ Select at least one book.",
    ...
    "ru": {
        ...
        "admin_notify_one_btn": "🔔 Напомнить (выбрать книги)",
        "admin_notify_chat_btn": "💬 Напомнить в чате (топ)",
        "admin_notify_chat_one_btn": "💬 Напомнить в чате (выбрать книги)",
        ...
        "choose_notify_books": "🔔 Нажимайте на книги для напоминания. Выбрано: <b>{count}</b>",
        "choose_notify_chat_books": "💬 Нажимайте на книги для публикации в чате. Выбрано: <b>{count}</b>",
        "notify_books_send_btn": "✅ Отправить напоминания",
        "notify_books_post_chat_btn": "✅ Опубликовать в чате",
        "notify_no_books_selected": "⚠️ Выберите хотя бы одну книгу.",
...
ENTITY_STRING_OVERLAYS: dict[str, dict[str, dict[str, TranslationValue]]] = {
    "film": {
        "en": {
            ...
            "admin_notify_one_btn": "🔔 Send reminder (pick films)",
            "admin_notify_chat_one_btn": "💬 Post reminder to chat (pick films)",
            "choose_notify_books": "🔔 Tap films to include in the reminder. Selected: <b>{count}</b>",
            "choose_notify_chat_books": "💬 Tap films to post in the group chat. Selected: <b>{count}</b>",
            "notify_books_send_btn": "✅ Send reminders",
            "notify_books_post_chat_btn": "✅ Post to chat",
            "notify_no_books_selected": "⚠️ Select at least one film.",
        ...
        "ru": {
            ...
            "admin_notify_one_btn": "🔔 Напомнить (выбрать фильмы)",
            "admin_notify_chat_one_btn": "💬 Напомнить в чате (выбрать фильмы)",
            "choose_notify_books": "🔔 Нажимайте на фильмы для напоминания. Выбрано: <b>{count}</b>",
            "choose_notify_chat_books": "💬 Нажимайте на фильмы для публикации в чате. Выбрано: <b>{count}</b>",
            "notify_books_send_btn": "✅ Отправить напоминания",
            "notify_books_post_chat_btn": "✅ Опубликовать в чате",
            "notify_no_books_selected": "⚠️ Выберите хотя бы один фильм.",
